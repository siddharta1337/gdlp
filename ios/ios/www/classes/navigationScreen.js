...
NavigationScreen.prototype.init = function() {
    ...
    $("#navigation").on( "pageshow", function() {
		...
		app.navigationScreen.longInterval = setInterval( function(){
			app.navigationScreen.displaySelectedWS()
		}, 300000)
    ...
    $("#navigation").on( "pagebeforehide", function() {
    	...
    	window.clearInterval( app.navigationScreen.longInterval )
    	console.log("mata")
    })
    ...
    $("#navigation_logout").on("click", function(e){
	...
	//$("#navigation").on("pagecreate", function(){
		...
		jQuery(function(){
		   ...
		   options = { lookup: filterItems  ,minChars:1 , containerClass:"autocomplete-suggestions navigatorComplete"};
...
NavigationScreen.prototype.displaySelectedWS = function(){
	...
	$.ajax({
		...
		error: function (response) {
			...
			$("#navigation_selected_count").html("")
		}
	});
}


NavigationScreen.prototype.refreshList = function(first_argument) {
	app.navigationScreen.displaySelectedWS()
};
