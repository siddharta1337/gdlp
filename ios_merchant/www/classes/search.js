...
Search.prototype.createItem = function(_itemData) {
    ...
    singleItem += '<img class="lazy2" src="img/placeholders/img1.png"  data-original="'+  _itemData.PreviewImage +'"  width="183" height="240" />';
...
Search.prototype.showError = function() {
    $("#search_resultList").html('<li class="errorHeader"> No Offers are available. </li>')
    $.mobile.loading( "hide" );
};
