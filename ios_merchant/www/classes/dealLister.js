...
DealList.prototype.callProperData = function() {
	console.log("invocando datos desde DB")
...
DealList.prototype.createItem = function(_itemData) {
	...
	singleItem += '<img class="lazy" src="img/placeholders/img1.png"  data-original="' + _itemData.PreviewImage + '"  width="183" height="240" />';
...
DealList.prototype.refreshList = function() {
	...
	//////////////////////////// GEOLOCATION READY (disabled for testing purposes ) ////////////////
				...
				var wait = setTimeout(function(){
						...
						navigator.geolocation.getCurrentPosition(function(e){
							...
							if(app.dealList._tempOutput == null){

								if(app.dealList.currentFilters.originLat != null ){
									app.dealList.currentFilters.originLat = e.coords.latitude
									app.dealList.currentFilters.originLong = e.coords.longitude
								}

								parametros = app.dealList.currentFilters
							} else{



								if(app.dealList._tempOutput.latitude != null ){
									app.dealList._tempOutput.latitude = e.coords.latitude
									app.dealList._tempOutput.longitude = e.coords.longitude

									console.log("coorenadas")
								}

								parametros = app.dealList._tempOutput

							}

							if(  !$.isEmptyObject(parametros) ){ 
							
								app.dealList.getOffersformWebService(parametros)
