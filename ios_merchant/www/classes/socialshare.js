...
Socialshare.prototype.email = function() {
	...
	var emailBody = this.itemData.Description + "  \n \n  " + app.SITE_URL  + this.itemData.DetailLink; //Wish%20you%20were%20here!"
...
Socialshare.prototype.twitter = function() {
	...
	$("#shared_twitter").on("tap", function(){
		...
		var _URL =  app.SITE_URL + app.details.socialshare.itemData.DetailLink
		
        var image
        if(app.details.itemData.ThumbImage != null){
            image =  app.details.itemData.ThumbImage
        }else{
            image =  app.details.itemData.PreviewImage
        }
...
Socialshare.prototype.facebok = function() {
	...
	$("#shared_facebook").on("tap", function(){
		...
		var URL = app.SITE_URL  + app.details.socialshare.itemData.DetailLink
