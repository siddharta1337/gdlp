...
MyOffers.prototype.init = function(first_argument) {
	...
	$( "#myOffers .availability .box" ).on( 'tap', function(){
		...
		$( "#myOffers .availability .box" ).removeClass("active")
		
		$(this).addClass("active")

		app.myOffers.activeTab  = $(this).attr("id");

		//localStorage.setItem("myOffers_activeTab",$(this).attr("id");//"already");
...
MyOffers.prototype.retrieveAllFromWs = function() {
		...
		if(app.myOffers.activeTab == "myOffersTab_expired"){
			sendData.exclusiveExpired = "true"
			//exclusiveExpired=true

		}else{
			 //sendData.redeemed = "false"
			 delete sendData.exclusiveExpired //= "false"
		}
...
MyOffers.prototype.createItem = function(_itemData) {
	...
	/// create the item
        ...
        singleItem += '<p class="dueDate">Unlock Code: <span> 0000000 </span></p>'; //EndsOn
        singleItem += '</li>';
